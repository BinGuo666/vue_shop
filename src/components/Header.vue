        ...
        <div class="navbar">
          <div class="navbar-left-container">
            <a href="/">
              ...
              <div style="font-size: 60px;letter-spacing: 10px;font-weight: 800;margin: 10px 0 20px 45%;color: #ab3c8ebf;font-family: '华文行楷';">斌果购物网</div>
            </a>
          </div>
          <div class="navbar-right-container" style="float: right;width: 180px;height: 100px;position: absolute;top: 20px;right: 0;">
            <div class="navbar-menu-container">
              <!--<a href="/" class="navbar-link">我的账户</a>-->
              <span class="navbar-link" v-text="nickName" v-if="nickName"></span>
              <a href="javascript:void(0)" class="navbar-link" @click="loginModalFlag=true" v-if="!nickName">Login</a>
              <a href="javascript:void(0)" class="navbar-link" @click="logOut" v-if="nickName">Logout</a>
              <div class="navbar-cart-container" style="width: 50px;float:  right;top: -64px;position: relative;left: -22px;">
                <span class="navbar-cart-count">{{cartCount}}</span>
                <svg class="navbar-cart-logo" style="width: 30px;">
                  <use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#icon-cart" style="float: right"></use>
                </svg>       <li class="navbar-link navbar-cart-link" href="/#/cart" >
          ...
          <div class="confirm-tips">
            ...
            <ul>
              ...
              <li class="regi_form_input noMargin">
                ...
                <input type="password" tabindex="2" name="password" v-model="userPwd" class="regi_login_input regi_login_input" placeholder="Password" @keyup.enter="login">
              </li>
            </ul>
          </div>
...
//              this.loginModalFlag = false;
          ...
          getCartCount(){
              axios.get("/users/getCartCount").then((response)=>{
                  let res = response.data;
                  this.$store.commit("updatecartCount",20);
              })
          }
        }
    }
